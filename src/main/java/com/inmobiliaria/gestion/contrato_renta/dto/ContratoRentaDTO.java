...
@Schema(description = "Data Transfer Object for ContratoRenta")
public record ContratoRentaDTO(
        
        @Schema(description = "Unique identifier for the rental contract", example = "1")
        Integer idContrato,

        @Schema(description = "ID of the property associated with this contract", example = "1")
        Integer idPropiedad,

        @Schema(description = "Contract start date", example = "2024-01-15T10:00:00")
        LocalDateTime fechaInicioContrato,

        @Schema(description = "Contract end date", example = "2024-12-15T10:00:00")
        LocalDateTime fechaFinContrato,
