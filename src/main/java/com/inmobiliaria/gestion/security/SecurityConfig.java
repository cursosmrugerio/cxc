    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/", "/index.html", "/login.html", "/register.html", "/inmobiliaria.html", "/inmobiliaria-add.html", "/inmobiliaria-edit.html", "/propiedades.html", "/propiedad-add.html", "/propiedad-edit.html", "/css/**", "/js/**", "/images/**", "/components/**", "/favicon.ico").permitAll()
