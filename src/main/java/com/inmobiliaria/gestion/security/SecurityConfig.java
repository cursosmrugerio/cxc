    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/", "/index.html", "/login.html", "/register.html", "/propiedades.html", "/conceptos-pago.html", "/configuracion-recargos.html", "/contratos-renta.html", "/css/**", "/js/**", "/images/**", "/components/**", "/favicon.ico").permitAll()
